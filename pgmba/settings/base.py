# flake8: noqa
"""
Django settings for pgmba project.
...
WSGI_APPLICATION = 'pgmba.wsgi.application'
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///pgmba'),
}
